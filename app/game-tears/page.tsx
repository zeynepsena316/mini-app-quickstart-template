...
export default function GameTearsPage() {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div style={{ marginTop: 16, color: "#333", fontSize: 15 }}>
        <strong>Nasıl oynanır</strong><br />
        Kunduz ağlarken gözyaşları rastgele yerlere doğru akıyor.<br />
        Kovayı hareket ettirerek gözyaşlarını yakala.<br />
        Her yakalanan gözyaşı +1 skor getirir. Aşağı düşenler "kaçırılan" sayısını artırır.
      </div>
    </div>
  )
}
